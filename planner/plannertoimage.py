...
class PlannerToImage():
    ...
    def __init__(self, planner, day):
        ...
        self.__header_font      = ImageFont.truetype(self.__path+"/../assets/fonts/Dosis-Bold.ttf", size=int(PlannerToImage.__HEIGHT/30))
        self.__subtitle_font    = ImageFont.truetype(self.__path+"/../assets/fonts/Ubuntu-B.ttf", size=int(PlannerToImage.__HEIGHT/49.6))
        self.__top_font         = ImageFont.truetype(self.__path+"/../assets/fonts/Ubuntu-B.ttf", size=int(PlannerToImage.__HEIGHT/60))
        self.__top_font_R       = ImageFont.truetype(self.__path+"/../assets/fonts/Ubuntu-R.ttf", size=int(PlannerToImage.__HEIGHT/60))
        self.__add_info_font    = ImageFont.truetype(self.__path+"/../assets/fonts/Ubuntu-R.ttf", size=int(PlannerToImage.__HEIGHT/82))
        self.__event_name_font  = ImageFont.truetype(self.__path+"/../assets/fonts/Ubuntu-R.ttf", size=int(PlannerToImage.__HEIGHT/82))
        self.__time_font        = ImageFont.truetype(self.__path+"/../assets/fonts/Ubuntu-R.ttf", size=int(PlannerToImage.__HEIGHT/82))
